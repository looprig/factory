...
// Open assembles providers and returns their Composite and owned PostgreSQL
// pool. The product must initialize SessionStore with a suitable service
// lifetime context and close it before closing the PostgreSQL pool.
// Open itself requires a bounded startup context.
func Open(ctx context.Context, cfg Config) (*storage.Composite, *pgstore.Store, error) {
